class SupplementaryUnit(object):
    def __init__(self, measurement_unit_code=None, measurement_unit_qualifier_code=None, quantity_code=None):
...
class UnmatchedSupplementaryUnit(object):
    def __init__(self, commodity_code, measurement_unit_code, measurement_unit_qualifier_code, chief_code):
